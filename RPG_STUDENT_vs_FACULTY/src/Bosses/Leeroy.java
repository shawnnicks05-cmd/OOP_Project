...
/**
 * Level 4 Boss: Leeroy - Heavy Damage Boss
 * @author user
 */
public class Leeroy extends GameBoss {

    public Leeroy() {
        super("Leeroy", "Heavy Damage Boss", "Medium-Hard", "Heavy AoE / Sonic Damage");
        this.hpBoss = 110;
        this.maxHp = 110;
        this.mana = 85;
        this.maxMana = 85;
    ...
    public String basicAttack(ArrayList<GameCharacter> partyStudents) {
        ...
        this.addRage(13);
        String rageAlert = this.isEnragedDoTActive() ? "[WARN] Leeroy's voice reaches deafening levels! Sanity damage active!" : "";
