...
/**
 * Level 2 Boss: Miro - Tactical Faculty Boss
 * @author user
 */
public class Miro extends GameBoss {

    public Miro() {
        super("Miro", "Tactical Faculty Boss", "Medium", "True Damage / Pure Evaluation");
        this.hpBoss = 95;
        this.maxHp = 95;
        this.mana = 80;
        this.maxMana = 80;
    ...
    public String basicAttack(ArrayList<GameCharacter> partyStudents) {
        ...
        if (chosenTarget != null) {
            ...
            String rageAlert = this.isEnragedDoTActive() ? " \n[WARN] Miro's precision is devastating! DoT active!" : "";
